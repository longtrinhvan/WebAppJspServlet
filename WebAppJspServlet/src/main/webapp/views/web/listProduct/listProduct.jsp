...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="<c:url value='/template/web/css/styles-list-product.css' />">
	...
	<script type="text/javascript" src="<c:url value='/views/web/listProduct/listProduct.js' />"></script>
</head>
		...
		<div class="left-product-div">
			<div class="left-seach-product-div">
				...
				<div class="loc-theo-gia-div">
					<h4>Giá:</h4>
					<input class="loc-theo-gia-input" type="text" placeholder="" id="CafeF_SearchKeyword_Company"
						autocomplete="off"> <input class="loc-theo-gia-input" type="text" placeholder=""
				...
				<div class="list-product-div" id="list-product-div">
					<c:forEach var="item" items="${productmodel}">
						<div class="dell-product-div">
							<p id="i-tags">-17%</p>
							<img class="img-dell-product-div" src='<c:url value="/template/web/image/${item.image}" />'>
							<h4>
					...
					<input type="hidden" value="${producerid}" id="producerid" /> <input type="hidden"
						value="${locationPage}" id="locationPage" /> <input type="hidden" value="${page}"
						id="pagecheck" />
				</div>
