...
<head>
	...
	<script type="text/javascript" src="<c:url value='/views/web/home/home.js' />"></script>
</head>
			...
			<ul>
				<c:forEach var="item" items="${producerModel}">
					<li class="ListBnn"><a>Laptop
							${item.nameproducer}</a><input type="hidden" value="${item.idproducer}"
							class="idproducerListBnn" /></li>
				</c:forEach>
			</ul>
		</div>
		<div class="big-img-banner-div">
			<img class="big-img-banner" src='<c:url value="/template/web/image/banner1.jpg" />'>
		</div>
		<div class="mini-img-banner-div">
			<img class="mini-img-banner" src='<c:url value="/template/web/image/banner2.jpg" />'> <img
				class="mini-img-banner" src='<c:url value="/template/web/image/banner3.jpg" />'>
		</div>
	</div>
	<div class="product">
		<div class="dell">
